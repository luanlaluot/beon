...
const members = [
  {
    ...
    cert: "Certified OKR (C-OKRP™), Certified PMP® (Google), Train the Trainer (Dale Carnegie), Instructional Design.",
    facebook: "#",
    linkedin: "#",
  },
  {
    ...
    cert: "MBA (University of Bolton); Cử nhân Sư phạm; Instructional Design Certificate; Points of You Practitioner.",
    facebook: "#",
    linkedin: "#",
  },
  {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative group">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl z-10 border-4 border-white aspect-[4/5] max-w-md mx-auto">
                ...
                />
                <div className={`absolute inset-0 bg-gradient-to-t ${member.gradient} to-transparent`} />
            ...
            <div className="space-y-8">
              <div className="space-y-3">
                <h2 className="text-4xl sm:text-5xl font-display font-bold text-foreground leading-tight tracking-tight">
                  {member.name}
                  {member.alias && (
                    <span className="block text-xl mt-2 text-foreground/50 font-normal">{member.alias}</span>
                  )}
                </h2>
        ...
        {members.length > 2 && (
          <div className="mt-16 flex gap-4 justify-center overflow-x-auto pb-2">
            {members.map((m, i) => (
              ...
              >
                <div className={`w-16 h-16 rounded-2xl overflow-hidden border-2 transition-all duration-300 ${
                  i === active ? "border-primary shadow-lg shadow-primary/20" : "border-border"
                }`}>
