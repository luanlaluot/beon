export default function Service() {
  return (
    <section className="py-24 bg-muted text-foreground relative overflow-hidden" id="philosophy">
      {/* Background Graphic */}
        ...
        <div className="grid gap-16 lg:grid-cols-2 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/10 text-accent font-semibold text-sm backdrop-blur-md border border-accent/20">
              ...
              >
                Đào tạo không chỉ là "Dạy", mà là sự <span className="text-primary">Thay Đổi</span>
              </h2>
            </div>
            ...
            <div className="space-y-6 text-foreground/80">
              ...
              >
                <p className="text-base leading-relaxed italic text-foreground/70">
                  "Chúng tôi không chạy theo 'đào tạo cho đủ', mà tập trung vào những trải nghiệm học tập mang lại thay đổi thật sự trong hành vi và hiệu suất công việc."
                </p>
              </div>
            </div>
