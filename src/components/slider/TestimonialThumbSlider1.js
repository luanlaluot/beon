      ...
      <div className="testimonial-sliders">
        ...
        >
          <div className="single-testimonial">
            <h5>
              “If your appetite is whetted, check out which tour might take your
              fancy, fill out the contact form or send an email so we can make
              an appointment. Tours are privately organised and tailor-made to
              suit most tastes.”
            </h5>
          ...
          <div className="single-testimonial">
            <h5>
              “The graphic and typographic operators know this well, in reality
              all the professions dealing with the universe of communication
              have a stable relationship with these words, but what is it? Lorem
              ipsum is a dummy text without any sense. ”
            </h5>
            <div className="author">
              <Link href="#">Leslie Alexander</Link>
              <p>CEO, Business Administ</p>
          ...
          <div className="single-testimonial">
            <h5>
              ...
              text : in short, its meaning can also be zero”
            </h5>
            <div className="author">
              <Link href="#">Leslie Alexander</Link>
              <p>CEO, Business Administ</p>
          ...
          <div className="single-testimonial">
            <h5>
              “Filling text generation tool, in addition to customizing the text
              with HTML elements, you have the possibility to create a new one
              starting directly from your text! ”
            </h5>
            <div className="author">
              <Link href="#">Leslie Alexander</Link>
              <p>CEO, Business Administ</p>
