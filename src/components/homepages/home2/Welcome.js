                ...
                >
                  ...
                  <Link href="/tel:7363534" className="theme-btn-15">
                    <span className="btn-icon">
                      <img src="/assets/img/icons/phone-icon-4.svg" alt="" />
                    </span>
            ...
            >
              <div className="hero-4-image">
                <div className="single-card">
                  ...
                  <img
                    className="card-shape-left"
                    src="/assets/img/shapes/shape31.png"
                    alt=""
                  />
                  <img
                    className="card-shape-right"
                    src="/assets/img/shapes/shape31.png"
                    alt=""
                  />
                  <img
                    className="card-shape-bottom"
                    src="/assets/img/shapes/shape31.png"
                    alt=""
                  />
                </div>
