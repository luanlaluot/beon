...
export default function CaseStudy() {
  return (
    <>
      <div className="case-study-2 section-padding">
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="hadding5">
                ...
                <div className="space10" />
                <p
                  className="font-f-5 font-20 line-height-32 weight-400 color-p-4"
                  data-aos="fade-down"
              ...
              <div className="row">
                ...
                >
                  ...
                  <div className="hadding5">
                    <div className="case-stady-icon">
                      <img
                        src="/assets/img/icons/home4-case-icon1.svg"
                        alt=""
                      />
                    </div>
                    <div className="space20"> </div>
                    <h4 className="font-f-6 line-height-20 font-20 weight-500 color4">
                      <Link href="#" className="color4">
                        Professional Service
                      </Link>
                    </h4>
                    <p className="font-16 weight-400 line-height-lg-26 font-f-5 color-p-4">
                      Our team of insurance professionals have the knowledge,
                      skills, markets and desire necessary to provide.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div className="hadding5">
                    <div className="case-stady-icon">
                      <img
                        src="/assets/img/icons/home4-case-icon2.svg"
                        alt=""
                      />
                    </div>
                    <div className="space20"> </div>
                ...
                >
                  ...
                  <div className="hadding5">
                    <div className="case-stady-icon">
                      <img
                        src="/assets/img/icons/home4-case-icon3.svg"
                        alt=""
                      />
                    </div>
                    <div className="space20"> </div>
                ...
                >
                  ...
                  <div className="hadding5">
                    <div className="case-stady-icon">
                      <img
                        src="/assets/img/icons/home4-case-icon4.svg"
                        alt=""
                      />
                    </div>
                    <div className="space20"> </div>
