    ...
    <>
      <div className="home4-work">
        <div className="container">
          <div className="row">
            <div className="col-md-7 m-auto text-center">
              <div className="hadding5">
                ...
                <h1
                  className="font-f-6 font-30 font-lg-42 weight-500 line-height-38 line-height-lg-48 color4"
                  data-aos="fade-up"
          ...
          <div className="space30" />
          {/* Second row: 2 items centered below the main 3 */}
          <div className="row justify-content-center">
            ...
            >
              <div className="home4-work-items-all">
                <div className="home4-work-items">
                  <div className="work-item-img-1">
                    <img src="/assets/img/image/work4-4.png" alt="" />
                  </div>
                  <div className="work-item-img-2">
                    <img src="/assets/img/image/work4-number-4.png" alt="" />
                  </div>
                </div>
                <div className="space70" />
                <div className="home5-work-hadding">
            ...
            >
              <div className="home4-work-items-all">
                <div className="home4-work-items">
                  <div className="work-item-img-1">
                    <img src="/assets/img/image/work4-5.png" alt="" />
                  </div>
                  <div className="work-item-img-2">
                    <img src="/assets/img/image/work4-number-5.png" alt="" />
                  </div>
                </div>
                <div className="space70" />
                <div className="home5-work-hadding">
